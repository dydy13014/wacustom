...
# Compatibilité avec les scrapers historiques de Wacustom. WAStream 3.7 a
# renommé ces fonctions, tandis que l'administration utilise les noms explicites.
get_links_by_imdb = get_wasource_links_by_imdb
get_links_by_title = get_wasource_links_by_title
